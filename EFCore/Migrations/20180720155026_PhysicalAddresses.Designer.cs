...
namespace EFCore.Migrations
{
    ...
    [Migration("20180720155026_PhysicalAddresses")]
    partial class PhysicalAddresses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore.Customer", b =>
                {
                    b.OwnsOne("EFCore.Address", "PhysicalAddress", b1 =>
                        {
                            ...
                            b1.HasOne("EFCore.Customer")
                                .WithOne("PhysicalAddress")
                                .HasForeignKey("EFCore.Address", "CustomerId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });

                    b.OwnsOne("EFCore.Address", "WorkAddress", b1 =>
                        {
                            b1.Property<int>("CustomerId")
                                .ValueGeneratedOnAdd()
                                .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
